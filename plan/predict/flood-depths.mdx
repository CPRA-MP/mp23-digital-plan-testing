...
<figure>
    <ComparisonMap
        beforeUrl="https://api.mpdp.coastal.la.gov/v1/datasets/flood_depth_ft/clara_grid_cell_v001/decadal/visualization/map.json?model_group_id=500&scenario_id=7&aep=1&pumping_id=0.5&fragility_scenario=0&population_variant=0&clara_variant=0&percentile=50&calendar_year=2070&show_grid_labels=false&show_grid_lines=false&show_projects=true&show_water=false"
        afterUrl="https://api.mpdp.coastal.la.gov/v1/datasets/flood_depth_ft/clara_grid_cell_v001/decadal/visualization/map.json?model_group_id=500&scenario_id=8&aep=1&pumping_id=0.5&fragility_scenario=0&population_variant=0&clara_variant=0&percentile=50&calendar_year=2070&show_grid_labels=false&show_grid_lines=false&show_projects=true&show_water=false"
    />
    <figcaption>
        **Flood Depths, 1% Annual Exceedance Probability, Future Without Action, Year 50:** The lower environmental scenariois on the left, and the higher environmental scenario is on the right. Move the slider to compare the two scenarios. You can also [explore flood depth data in the Master Plan Data Portal](https://mpdp.coastal.la.gov/#aep=1&calendar_year=2070&clara_variant=0&fragility_scenario=0&grid=clara_grid_cell_v001&map=8.00/29.70/-91.37&model_group_id=500&percentile=50&population_variant=0&pumping_id=0.5&scenario_id=7&show_grid_lines=false&time_unit=decadal&variable=flood_depth_ft) or download the [lower scenario CSV](https://api.mpdp.coastal.la.gov/v1/datasets/flood_depth_ft/clara_grid_cell_v001/decadal/data.csv?model_group_id=500&scenario_id=7&aep=1&pumping_id=0.5&fragility_scenario=0&population_variant=0&clara_variant=0&percentile=50&calendar_year=2070) or [higher scenario CSV](https://api.mpdp.coastal.la.gov/v1/datasets/flood_depth_ft/clara_grid_cell_v001/decadal/data.csv?model_group_id=500&scenario_id=8&aep=1&pumping_id=0.5&fragility_scenario=0&population_variant=0&clara_variant=0&percentile=50&calendar_year=2070).
    </figcaption>
</figure>
